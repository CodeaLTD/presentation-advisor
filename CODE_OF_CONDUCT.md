...
To report unacceptable behavior, use the repository maintainers' private contact channel (GitHub private report if available). If no private channel is available, contact maintainers through GitHub and request a non-public follow-up.
